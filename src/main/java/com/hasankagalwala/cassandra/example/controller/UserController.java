package com.hasankagalwala.cassandra.example.controller;
...
import com.hasankagalwala.cassandra.example.rpository.UserRepository;
...
public class UserController {
	...
	public void saveUser() {
		...
		users.add(new User(6437, "Hasan", "Hyderabad", 50));
